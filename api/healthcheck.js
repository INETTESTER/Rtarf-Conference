...
//     if (!KNOWN_STATUS.includes(s)) {
//         if (s === 0) {
//             // network error — ไม่มี body, ดู error_code + remote + proto + phase breakdown แทน
...
//                 `phase[connect=${t.connecting} tls=${t.tls_handshaking} send=${t.sending} wait=${t.waiting} recv=${t.receiving}]`
//             );
//         } else {
//             // HTTP error จริง — มี body ให้ดู
//             const label = STATUS_TEXT[s] || 'Unknown';
